 ...
 */
public class MentionsFragment extends Fragment implements MessageView{
    ...
    private void loadData() {
        if (!isDatasLoaded&&isVisible){
            presenter.getMessages(this.getContext());
            isDatasLoaded = true;
        }
    }
    ...
    public void updateCommentList(List<Comment> comments) {
        System.out.println("mentions count:"+comments.size());
