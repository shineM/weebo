 ...
 * @since 2013-11-22
 */
public class Feed extends MultiItemEntity implements Parcelable,Serializable {
    /**
     * 原创微博
     */
    ...
    public static Feed parse(JSONObject jsonObject) {
        ...
        status.retweeted_status = Feed.parse(jsonObject.optJSONObject("retweeted_status"));
    ...
    protected Feed(Parcel in) {
        ...
        this.retweeted_status = in.readParcelable(Feed.class.getClassLoader());
